...
public class Utilities {
    ...
    public static double RateExchangeAtCurrentPrice(Fund over, Fund under) {
        int daysOpenInLastYear = 0; // TODO: get this value from the fetcher
        int todaysIndex = 0; // TODO: get this value from the fetcher
        double [] overPrices = new double[0]; // TODO: get price history from the fetcher
        double [] underPrices = new double[0]; // also get this from the fetcher too
